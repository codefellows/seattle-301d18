...
- Announcements
  ...
  - Do not forget that the exam is open-book, open-Google, open-Stack_Overflow, whatever resources you want to use. The exam is designed to be, in spots, a little bit beyond what we have covered. The intent in those spots is to measure your resourcefulness and ability to adapt and figure something out. Be sure to leave yourself adequate time, like 1-2 hours depending if you are fast or slow on these kinds of things.
	...
	- Note that any unsubmitted assignments will be marked as a (temporary) zero on Monday. This is not punitive nor permanent: it is meant to be informative to show you where your grade would stand if you never submit that assignment.
	- To get any late work (or resubmits for higher grades) turned in after project week, make a plan for that with Sam and/or our Admissions team so they know what you're working on. Also be aware of how your work progress and grades overlap with admissions requirements and deadlines for upcoming 401 courses. Enrollments are running high and we are already establishing waitlists for upcoming 401s.
...
- Where were we at the end of 201? [1](https://endere.github.io/Histicuffs/index.html) [2](https://kurtrm.github.io/time-wizards/) [3](https://christophersclosser.github.io/fight-code/) [4](https://aesthetiques.github.io/swole_devs/)
